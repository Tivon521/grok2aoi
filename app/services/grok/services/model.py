...
class ModelService:
    ...
    MODELS = [
        ...
        ModelInfo(
            model_id="grok-4.2",
            grok_model="grok-4-2",
            model_mode="MODEL_MODE_GROK_4_2",
            tier=Tier.BASIC,
            cost=Cost.LOW,
            display_name="GROK-4.2",
            description="Latest Grok 4.2 model",
            is_image=False,
            is_image_edit=False,
            is_video=False,
        ),
        ModelInfo(
            model_id="grok-4.2-mini",
            grok_model="grok-4-2-mini",
            model_mode="MODEL_MODE_GROK_4_2_MINI",
            tier=Tier.BASIC,
            cost=Cost.LOW,
            display_name="GROK-4.2-MINI",
            description="Lightweight Grok 4.2 model",
            is_image=False,
            is_image_edit=False,
            is_video=False,
        ),
        ModelInfo(
            model_id="grok-4.2-thinking",
            grok_model="grok-4-2",
            model_mode="MODEL_MODE_GROK_4_2_THINKING",
            tier=Tier.BASIC,
            cost=Cost.HIGH,
            display_name="GROK-4.2-THINKING",
            description="Grok 4.2 with deep reasoning",
            is_image=False,
            is_image_edit=False,
            is_video=False,
        ),
        ModelInfo(
            ...
            grok_model="grok-vision",
            model_mode="MODEL_MODE_VISION",
            tier=Tier.BASIC,
            cost=Cost.HIGH,
            display_name="GROK-VISION",
            description="Vision understanding model",
            is_image=False,
            is_image_edit=False,
            is_video=False,
        ),
